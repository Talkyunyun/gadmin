...
@section('content')
<div class="live_face">
    <div class="live_face_img" style="background:#ddd url({{ $live['cover'] or config('site.msg_default_bg') }}) no-repeat center center;background-size:cover;"></div>
    <div class="live_status_tips_bg">
        <div class="live_status_tips">
            <h1>{{ $msg or trans('msg.live_not_exist') }}</h1>
